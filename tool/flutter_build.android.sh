...
cd ../thorvg
meson setup -Db_lto=true -Ddefault_library=static -Dloaders="lottie, svg, png, jpg" -Dextra="lottie_exp" -Dthreads=false --cross-file /tmp/.flutter_android_cross.txt ../tool/build_flutter_aarch64
...
cd ../thorvg
meson setup -Db_lto=true -Ddefault_library=static -Dloaders="lottie, svg, png, jpg" -Dextra="lottie_exp" -Dthreads=false --cross-file /tmp/.flutter_android_cross.txt ../tool/build_flutter_x86_64
